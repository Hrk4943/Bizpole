            ...
            <form className="md:px-4 lg:px-10 bg-white">
              <div className=" mt-3 ">
                <div className="input-container">
                  <label htmlFor="name" className="text-gray-900 mt-">
                    Type
              ...
              <hr className="show-line hide-line"></hr>
              <div className="">
                <div className="">
                  <div className="w-96">
                    <div className="input-container">
                      <select
                        id="type"
                        className="border border-gray-300  text-blue-700 bg-white mt-10  p-3 focus:outline-none focus:shadow-outline"
                        default="GST"
                        style={{ width: "110%" }}   
                      >
                        <option>GST</option>
